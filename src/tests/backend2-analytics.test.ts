...
describe('website statistics', () => {
  ...
  it('reports a not-built contact form and live catalogue counts', async () => {
    ...
    expect(metric(data, 'website.contactSubmissions')).toMatchObject({ state: 'not-built', value: null })

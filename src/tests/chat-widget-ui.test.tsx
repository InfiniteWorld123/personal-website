...
/**
 * The public chat widget (`docs/v2/public-cutover.md`, step 7): it asks
 * Backend2, shows the approved notice, sources, Contact/Booking, and answers
 * in the question's direction.
 */

const state = vi.hoisted(() => ({ language: 'de' as 'de' | 'en' | 'ar' }))
...
describe('the chat widget', () => {
  it('asks Backend2, with the notice, sources and links', async () => {

    ...
    >
            ...
            {(field) => (
              <div className="flex flex-col gap-2">
                ...
                <p className="text-muted-foreground text-xs">
                  The address becomes /de/blog/{field.state.value || 'slug'}. Changing it breaks
                  existing links.
                </p>
              </div>
            )}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            One tab per language. A tab with no title is treated as not written yet.
          </CardDescription>
        </CardHeader>
        <CardContent>
                ...
                <form.Field name={`translations.${language}.excerpt`}>
                  {(field) => (
                    <div className="flex flex-col gap-2">
                      ...
                      />
                      <p className="text-muted-foreground text-xs">
                        Plain text. It is the card summary, the search-result description, and the
                        feed entry, so it is the sentence that has to earn the click.
                      </p>
                    </div>
                  )}
                </form.Field>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Optional. Shown on the card, at the top of the article, and on the social card. With a
            cover, alt text is required in all three languages.
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            What the archive filters by. Tags are written once, in all three languages.
          </CardDescription>
        </CardHeader>
          ...
          return (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  A published post is readable by every visitor, in all three languages.
                </CardDescription>
              </CardHeader>
              <CardContent className="flex flex-col gap-4">

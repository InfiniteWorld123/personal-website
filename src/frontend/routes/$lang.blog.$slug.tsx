...
export const Route = createFileRoute('/$lang/blog/$slug')({
  ...
  head: ({ params, loaderData }) => {
    ...
    const head = buildHead({
      ...
      // language, falling back to the title and summary.
      title: `${post.seo.title} · ${getContent(language).blog.eyebrow}`,
    ...
    // The comment section, the table and the video styles.
    return { ...head, links: [...head.links, { rel: 'stylesheet', href: blogV2Css }] }
  },
  component: PostRoute,
})

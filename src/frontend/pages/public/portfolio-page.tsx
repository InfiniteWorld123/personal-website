...
export function PortfolioPage() {
  // Language, persistence, and document lang/dir are owned by LanguageProvider.
...
function ThemeToggle() {
  // Theme state, persistence, and the `.dark` class are owned by ThemeProvider.
